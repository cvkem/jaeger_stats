...
pub struct Call {
    #[serde(alias = "process")] // old name used in previous version of StatsRec
    pub service: String,
    #[serde(alias = "method")] // old name used in previous version of StatsRec
...
impl ToString for Call {
    fn to_string(&self) -> String {
        match self.call_direction {
            CallDirection::Unknown => self.service.to_owned() + "/" + &self.operation,
            _ => {
                self.service.to_owned()
                    + "/"
                    + &self.operation

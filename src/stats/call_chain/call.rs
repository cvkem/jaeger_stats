...
pub struct Call {
    ...
    pub method: String,  // should be called Operation. However, does that impact existing datafiles? To be solved by Serde-Aliases. But this is not in StatsRec and nog in Stiched.
    #[serde(default)]

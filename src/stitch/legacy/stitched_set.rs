use super::{
    super::StitchedSet,
    stitched_line::{LegacyStitchedLine, LegacyStitchedLineJson},
};
...
#[derive(Default, Debug, Deserialize, Serialize)]
pub struct LegacyStitchedSetJson(pub Vec<LegacyStitchedLineJson>);

/// Implement Into directly as we do not want or need/accept the Operation from Stitched to LegacyStitched.
impl TryInto<StitchedSet> for LegacyStitchedSetJson {
    type Error = &'static str;
